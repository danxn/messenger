...
class Notes extends Component {
  ...
  render() {
    return ( <
      Widget title = "Notes"
      icon = {
        this.props.icon ? this.props.icon : "M6 7 H 20 L 26 12 V 26 H 6 L 6 7 M20 7 L20 12 L26 12 M11 13 L 16 13 M11 17 L 21 17 M11 21 L 21 21"
      }
      width = "200"
      height = "500"
      version = "0.01"
      ...
      /> <
      Note content = "Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat."
      delay = {
        0
      }
      onDisplayngComplete = {
        () => this.displayingNotes(1)
      }
      ref = {
        (note) => {
          this.r.note[1] = note;
      ...
      /> <
      Note content = " Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur."
      delay = {
        0
      }
      onDisplayngComplete = {
        () => this.displayingNotes(2)
      }
      ref = {
        (note) => {
          this.r.note[2] = note;
